...
<div class="col-xs-12 col-md-8">
  ...
  <ul>
    <li>Developed internal web applications driven by PHP, MySQL, AJAX,
      and JavaScript.</li>

    <li> Developed a sales page generator with customized Content Management
      System.</li>

    <li>Administrated LAMP web server.</li>
  </ul>
